...
print("This type of dictionary is an [Int : String], The key is an Integer and the value is a String. This dictionary is a short hand type of dictionary. i created this type of dictionary so it can map the integer to its english word.")
...
["cumulative" : "Increase of growing by a cumulation or successive additions",
"mnemonic" : "a name assigned to a machine function",
...
print("after running 2.0, it printed the word and the definition of the word next to it")
...
print("it printed the meaning of the word")
...
// Print out what happened when you ran 2.1.0
 ...
 print("when i ran 2.1.0, it printed the values of the favoriteWords dictionary ")
...
//Don't kill yourself over this answer. Just try.
 ...
 print("the type of the outputted variable from problem 2.1.0 is a dictionary value.")
...
for value in favoriteWords.values {
    print(value)
}
...
//Print out what happened when you ran 2.4.
 print("when i ran 2.4. it printed only the values of the dictionary")
